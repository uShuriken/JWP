        ...
        <div className="bg-white">
            ...
            <section className="py-24 px-4 bg-white">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
                    ...
                    <div className="md:w-1/2 order-1 md:order-2">
                        <h3 className="text-3xl md:text-4xl font-extrabold font-heading text-button-text mb-6">Local Expertise: Dedicated to the Levin Community</h3>
            ...
            <section className="py-24 px-4 bg-secondary">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16">
                    <div className="md:w-1/2">
                        <h3 className="text-3xl md:text-4xl font-extrabold font-heading text-button-text mb-6">Clinical Philosophy: A Holistic, Practical Approach</h3>
                        <p className="text-lg text-button-text/90 leading-relaxed mb-6">
                        ...
                        <p className="text-lg text-button-text/90 leading-relaxed font-medium">
                    ...
                    <div className="md:w-1/2 flex flex-col gap-8">
                        <div className="bg-white p-8 rounded-2xl">
                            <h4 className="text-xl font-bold font-heading text-button-text mb-4 pb-2">Techniques & Methods</h4>
                            <ul className="space-y-3">
                                {[
                                    ...
                                    <li key={i} className="flex items-start">
                                        ...
                                        <span className="text-button-text/80 font-medium">{item}</span>
                                    </li>
                                ))}
                            </ul>
            ...
            <section className="py-24 px-4 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h3 className="text-3xl md:text-4xl font-extrabold font-heading text-button-text">Credentials: Experience You Can Trust</h3>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        <div className="bg-white border border-primary/30 shadow-[0_4px_20px_rgb(0,0,0,0.03)] p-10 rounded-3xl relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-48 h-48 bg-secondary rounded-bl-[150px] z-0 opacity-50"></div>
                            <div className="relative z-10">
                                <h4 className="text-2xl font-bold font-heading text-button-text mb-6 pb-4 border-b border-primary/30">Qualifications</h4>
                                <ul className="space-y-4">
                                    <li className="flex items-start bg-white p-4 rounded-lg">
                                        <span className="text-primary font-bold text-xl mr-3">•</span>
                                        <span className="text-button-text/90 font-medium pt-1">Diploma of Physiotherapy</span>
                                    </li>
                                    <li className="flex items-start bg-white p-4 rounded-lg">
                                        <span className="text-primary font-bold text-xl mr-3">•</span>
                                        <span className="text-button-text/90 font-medium pt-1">Postgraduate Diploma of Rehabilitation</span>
                                    </li>
                                    <li className="flex items-start bg-white p-4 rounded-lg">
                                        <span className="text-primary font-bold text-xl mr-3">•</span>
                                        <span className="text-button-text/90 font-medium pt-1">Masters in Health Science (rehabilitation)</span>
                                    </li>
                                    <li className="flex flex-col bg-white p-4 rounded-lg border-l-4 border-primary">
                                        <div className="flex items-start">
                                            <span className="text-button-text/90 font-bold">Postgraduate Certificate in Health Science</span>
                                        </div>
                                        <span className="text-sm text-button-text/80 italic mt-1 font-medium pb-1 pl-1">
                        ...
                        <div className="flex flex-col gap-8">
                            <div className="bg-white p-8 rounded-3xl flex-1 border border-primary/30 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_4px_20px_rgb(0,0,0,0.06)] transition-shadow">
                                <h4 className="text-2xl font-bold font-heading text-button-text mb-4">Commitment to Learning</h4>
                                <p className="text-lg text-button-text/90 leading-relaxed">
                            ...
                            <div className="bg-white p-8 rounded-3xl flex-1 border border-primary/30 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_4px_20px_rgb(0,0,0,0.06)] transition-shadow">
                                <h4 className="text-2xl font-bold font-heading text-button-text mb-4">Occupational Focus</h4>
                                <p className="text-lg text-button-text/90 leading-relaxed">
            ...
            <section className="py-16 px-4 bg-secondary/30">
                <div className="max-w-4xl mx-auto">
                    {dynamicContent && (
                        <div className="bg-white p-8 rounded-2xl">
                            <h2 className="text-2xl font-bold font-heading text-button-text mb-6">More About Joanne</h2>
                            <div
                                className="prose max-w-none text-button-text/80"
